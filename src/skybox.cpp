...
void SkyBox::InitFront(const char *imageDir) {
	mShader[0].Init("../resources/skybox.vs", "../resources/skybox.fs");
	char temp[256];
	memset(temp, 0, 256);
...
void SkyBox::InitBack(const char *imageDir) {
	mShader[1].Init("../resources/skybox.vs", "../resources/skybox.fs");
	char temp[256];
	memset(temp, 0, 256);
	strcpy(temp, imageDir);
...
void SkyBox::InitLeft(const char *imageDir) {
	mShader[2].Init("../resources/skybox.vs", "../resources/skybox.fs");
	char temp[256];
	memset(temp, 0, 256);
	strcpy(temp, imageDir);
...
void SkyBox::InitRight(const char *imageDir) {
	mShader[3].Init("../resources/skybox.vs", "../resources/skybox.fs");
	char temp[256];
	memset(temp, 0, 256);
	strcpy(temp, imageDir);
...
void SkyBox::InitTop(const char *imageDir) {
	mShader[4].Init("../resources/skybox.vs", "../resources/skybox.fs");
	char temp[256];
	memset(temp, 0, 256);
	strcpy(temp, imageDir);
	strcat(temp, "top.bmp");
...
void SkyBox::InitBottom(const char *imageDir) {
	mShader[5].Init("../resources/skybox.vs", "../resources/skybox.fs");
	char temp[256];
	memset(temp, 0, 256);
	strcpy(temp, imageDir);
...
void SkyBox::Draw(float cameraX, float cameraY, float cameraZ, glm::mat4 &V, glm::mat4&P) {
	glDisable(GL_DEPTH_TEST);
	glm::mat4 modelMatrix = glm::translate(cameraX, cameraY, cameraZ);
